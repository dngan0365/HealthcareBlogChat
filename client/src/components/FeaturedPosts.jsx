    ...
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link className="text-[#4CAF4F] lg:text-lg">{posts[0].category}</Link>
        ...
        {posts[1] && <div className="lg:h-1/3 flex justify-between gap-4">
          ...
          <div className="w-2/3">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
              ...
              <Link className="text-[#4CAF4F]">{posts[1].category}</Link>
        ...
        {posts[2] && <div className="lg:h-1/3 flex justify-between gap-4">
          ...
          <div className="w-2/3">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
              ...
              <Link className="text-[#4CAF4F]">{posts[2].category}</Link>
        ...
        {posts[3] && <div className="lg:h-1/3 flex justify-between gap-4">
          ...
          <div className="w-2/3">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
              ...
              <Link className="text-[#4CAF4F]">{posts[3].category}</Link>
